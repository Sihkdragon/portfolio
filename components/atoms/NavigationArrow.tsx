...
const NavigationArrow = ({ sideUp = true }: NavigationArrowProps) => {
  if (sideUp) {
    return (
      ...
      >
        <div className="w-1 h-28 bg-main group-hover:h-44 duration-1000 rounded -mb-1"></div>
  ...
  return (
    ...
    >
      <div className="w-1 h-28 bg-main group-hover:h-44 duration-500 rounded -mb-1"></div>
